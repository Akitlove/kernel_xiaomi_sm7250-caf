...
static void update_firmware_override(int choice) {
	switch (choice) {
		...
		case 2:  touch_fw_name = "novatek_nt36672c_g7a_fw02.bin"; break;
		case 3:  touch_fw_name = "novatek_nt36672c_g7a_fw03.bin"; break;
		case 4:  touch_fw_name = "novatek_nt36672c_g7a_mp01.bin"; break;
		case 5:  touch_fw_name = "novatek_nt36672c_g7a_mp02.bin"; break;
		case 6:  touch_fw_name = "novatek_nt36672c_g7a_mp03.bin"; break;
	}
}
