...
static int onewire_gpio_probe(struct platform_device *pdev)
{
	...
	ow_log("onewire_data->gpio_cfg66_reg is %x; onewire_data->gpio_in_out_reg is %x", (uint32_t)(uintptr_t)(onewire_data->gpio_cfg66_reg), (uint32_t)(uintptr_t)(onewire_data->gpio_in_out_reg));
